...
public class FilterClustersMouseListener implements MouseListener {
    
    public static FilterClustersMouseListener classInstance;
    
    FilterClustersMouseListener() {
        classInstance = this;
    }

    public void mouseClicked(MouseEvent me) {

        if (me.getComponent() == FilterClustersJDialog.classInstance.filterClustersHelpButton) {
            new FilterClustersHelpJDialog();
        }
