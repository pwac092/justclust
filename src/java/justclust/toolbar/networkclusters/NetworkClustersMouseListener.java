...
public class NetworkClustersMouseListener implements MouseListener {

    public void mouseClicked(MouseEvent me) {

        if (me.getComponent() == NetworkClustersJDialog.classInstance.networkClustersHelpButton) {
            new NetworkClustersHelpJDialog();
        }
