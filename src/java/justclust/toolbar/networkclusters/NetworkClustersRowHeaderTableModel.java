...
import justclust.toolbar.networknodes.*;
...
public class NetworkClustersRowHeaderTableModel extends AbstractTableModel {

    String[] columnNames;
    Object[][] tableData;

    public NetworkClustersRowHeaderTableModel() {
        updateTable();
    }
    ...
    public void updateTable() {
        ...
        tableData = new String[data.networkClusters.size() + 1][1];
        tableData[0][0] = "All";
