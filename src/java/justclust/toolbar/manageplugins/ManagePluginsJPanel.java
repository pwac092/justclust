...
public class ManagePluginsJPanel extends JPanel {

    // this method extends the super class' paint method with additional
    // graphics to display in the ManagePluginsJPanel
    public void paint(Graphics g) {

        // the paint method of the super class is called so that the parts of
        // the ManagePluginsJPanel which are not painted in this method are
        ...
        g.fillRect(10,
                ...
                - 103.5 + (10)),
                getWidth() - (10 + 10),
                1 + 10 + 25 + 10 + 25 + 10 + 25 + 10 + 25 + 10 + 25 + 10 + 1);
