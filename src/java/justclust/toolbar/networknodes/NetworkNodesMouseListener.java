...
public class NetworkNodesMouseListener implements MouseListener {

    public void mouseClicked(MouseEvent me) {

        if (me.getComponent() == NetworkNodesJDialog.classInstance.networkNodesHelpButton) {
            new NetworkNodesHelpJDialog();
        }
