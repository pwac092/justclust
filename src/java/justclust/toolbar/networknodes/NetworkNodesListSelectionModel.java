 ...
 */
public class NetworkNodesListSelectionModel implements ListSelectionModel, Cloneable, Serializable {
    ...
    private void changeSelection(int clearMin, int clearMax,
        ...
        // when the visibility or colour of a Node is changed and the Node is
        // already selected in the table, no selection changes should occur.
        // this will mean that all previously selected Nodes will remain
        // selected.
        if (NetworkNodesJDialog.classInstance.networkNodesDialogJTable.getSelectedColumn() >= 1
                && setMin == setMax
    ...
    public Object clone() throws CloneNotSupportedException {
        NetworkNodesListSelectionModel clone = (NetworkNodesListSelectionModel) super.clone();
