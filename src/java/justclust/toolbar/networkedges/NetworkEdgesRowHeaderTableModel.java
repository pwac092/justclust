...
public class NetworkEdgesRowHeaderTableModel extends AbstractTableModel {

    String[] columnNames;
    Object[][] tableData;

    public NetworkEdgesRowHeaderTableModel() {
        updateTable();
    }
    ...
    public void updateTable() {
        ...
        tableData = new String[data.networkEdges.size() + 1][1];
        tableData[0][0] = "All";
