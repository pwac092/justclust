 ...
 */
public class NetworkEdgesListSelectionModel implements ListSelectionModel, Cloneable, Serializable {
    ...
    private void changeSelection(int clearMin, int clearMax,
        ...
        // when the visibility or colour of an Edge is changed and the Edge is
        // already selected in the table, no selection changes should occur.
        // this will mean that all previously selected Edges will remain
        // selected.
        if (NetworkEdgesJDialog.classInstance.networkEdgesDialogJTable.getSelectedColumn() >= 1
                && NetworkEdgesJDialog.classInstance.networkEdgesDialogJTable.getSelectedColumn() <= 3
                && setMin == setMax
    ...
    public Object clone() throws CloneNotSupportedException {
        NetworkEdgesListSelectionModel clone = (NetworkEdgesListSelectionModel) super.clone();
