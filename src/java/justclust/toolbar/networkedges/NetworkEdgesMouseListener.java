...
public class NetworkEdgesMouseListener implements MouseListener {

    public void mouseClicked(MouseEvent me) {

        if (me.getComponent() == NetworkEdgesJDialog.classInstance.networkEdgesHelpButton) {
            new NetworkEdgesHelpJDialog();
        }
