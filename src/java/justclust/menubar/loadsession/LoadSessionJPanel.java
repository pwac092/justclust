...
public class LoadSessionJPanel extends JPanel {
    ...
    // graphics to display in the LoadSessionJPanel
    public void paint(Graphics g) {

        // the paint method of the super class is called so that the parts of
        // the LoadSessionJPanel which are not painted in this method are
        ...
        if (LoadSessionJDialog.classInstance.loadSessionJProgressBar.getParent() == this) {
