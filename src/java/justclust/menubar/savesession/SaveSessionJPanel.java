...
public class SaveSessionJPanel extends JPanel {

    // this method extends the super class' paint method with additional
    // graphics to display in the SaveSessionJPanel
    public void paint(Graphics g) {

        // the paint method of the super class is called so that the parts of
        // the SaveSessionJPanel which are not painted in this method are
        ...
        if (SaveSessionJDialog.classInstance.saveSessionJProgressBar.getParent() == this) {
