...
public class ExportNetworkJPanel extends JPanel {

    // this method extends the super class' paint method with additional
    // graphics to display in the ExportNetworkJPanel
    public void paint(Graphics g) {

        // the paint method of the super class is called so that the parts of
        // the ExportNetworkJPanel which are not painted in this method are
        ...
        // saveNetworkJProgressBar has been added to the ExportNetworkJDialog
        // because a network is being saved.
        // if the saveNetworkJProgressBar has been added, this affects
        ...
        if (ExportNetworkJDialog.classInstance.exportNetworkJProgressBar.getParent() == this) {
